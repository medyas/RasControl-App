...
/**
 * Created by Mohamed Yassine on 9/21/2017.
 * Authors
 ...
 Also, thanks to @Bernix01, @teancake, @Spettacolo83, @djjaysmith, @jaybkim1 and @sikrinick for contributing.
...
public class JoystickView extends View
    ...
    */
    ...
    public interface OnMoveListener {
         ...
         */
        void onMove(int angle, int strength, int posx, int posy);
    }
    ...
    */
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if (event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if (mCallback != null)
                mCallback.onMove(getAngle(), getStrength(), getPosx(), getPosy());
        }
    ...
    public  int getW() { return  getWidth();}
    public int getB() {return mBorderRadius ;}
